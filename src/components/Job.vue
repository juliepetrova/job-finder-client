...
<!--      Apply now-->
      ...
      <div class="flex py-16 pb-0 ">
        <div class="w-6/12 text-xl rounded-3xl shadow p-16 pt-12 pb-20 mr-5 ">
          ...
          <div class="mt-20 flex justify-end text-gray-500"><a class="underline" @click="addReportMessage" href="#">Report</a></div>
        </div>
        <div class="w-5/12 mt-2 ml-24 rounded-3xl shadow-inner p-4 px-16 ">
            ...
            <div class="flex pt-4 px-4">
              <div class="text-xl text-center pb-4 font-bold text-gray-900 "><h4 class="rounded-full h-16 w-20 shadow-xl inline-block py-3  bg-red-300">{{user.jobs.length}} </h4> </div>
              <h4 class="text-center text-xl text-gray-900 p-3 px-4 ">Jobs posted</h4>
            </div>
          <div class="flex py-2 px-4">
            <div class="text-xl text-center pb-4 font-bold text-gray-900 "><h4 class="rounded-full h-16 w-20 shadow-xl inline-block py-3  bg-red-400">{{ countPayment() }} </h4> </div>
            <h4 class="text-center text-xl text-gray-900 p-3 px-4">Total euro payed</h4>
          </div>
          <div class="flex py-2 px-4">
            <div class="text-xl text-center pb-4 font-bold text-gray-900 "><h4 class="rounded-full h-16 w-20 shadow-xl inline-block py-3  bg-red-500">Email </h4> </div>
