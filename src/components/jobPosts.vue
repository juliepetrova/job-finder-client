<template>
  <div class="jobs">
    <div class="curved bg-indigo-700">
      <h1 class="p-8">Boulot</h1>
      <p class="p-4"> We'll help you find the ideal next small job</p>
    ...
    <h3 class="text-center text-3xl"> Available jobs</h3>
    <!--    Sort and Filter -->
        ...
        <div class="dropdown inline-block relative">
          ...
          <ul class="dropdown-menu absolute hidden text-indigo-700 pt-1">
            <li class=""><a class="rounded-t hover:bg-indigo-300 py-2 px-4 block whitespace-no-wrap "
                            href="#">Payment high to low</a></li>
            <li class=""><a class="hover:bg-indigo-300 py-2 px-4 block whitespace-no-wrap" href="#">Payment low to high</a></li>
            <li class=""><a class="hover:bg-indigo-300 py-2 px-4 block whitespace-no-wrap"
                            href="#">Date published</a></li>
            <li class=""><a class="rounded-b hover:bg-indigo-300 py-2 px-4 block whitespace-no-wrap"
                            href="#">Date of job</a></li>
          </ul>
        </div>
...
.curved {
  ...
  color: white;
  text-align: center;
  background-image: url("https://www.aelmarkhams.co.uk/wp-content/uploads/2017/12/jobs-background-image.jpg");
